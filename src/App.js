...
import { AuthProvider } from './contexts/AuthContext'; // 🔥 NOVO - PARA O SISTEMA
import { AuthClienteProvider } from './contexts/AuthClienteContext'; // Para clientes
...
function App() {
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <FeedbackProvider>
        {/* DADOS PROVIDER - COMPARTILHA DADOS GLOBAIS */}
        <DadosProvider>
          {/* 🔥 AUTH PROVIDER - AUTENTICAÇÃO DO SISTEMA (ADMIN/FUNCIONÁRIOS) */}
          <AuthProvider>
