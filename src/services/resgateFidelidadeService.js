    ...
    try {
      ...
      const resgate = {
        ...
        recompensa: {
          id: recompensaId,
          nome: recompensaNome,
          tipo: recompensa.tipo || dados.tipo || '',
          valor: recompensa.valor ?? dados.valor ?? 0,
          itemRelacionadoTipo: recompensa.itemRelacionadoTipo || dados.itemRelacionadoTipo || '',
          itemRelacionadoId: recompensa.itemRelacionadoId || dados.itemRelacionadoId || '',
          itemRelacionadoNome: recompensa.itemRelacionadoNome || dados.itemRelacionadoNome || '',
        },
        pontosGastos,
